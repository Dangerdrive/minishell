...
SRC = 	./src/builtins/cd.c \
		...
		./src/lexer/parse_redir_utils.c \
		./src/expand/expander.c \
		./src/expand/expander_utils.c \
		./src/expand/expander_utils2.c \
		...
		./src/execution/exec_processes_utils2.c \
...
norm:
	norminette src/ includes/ | grep Error | grep -v INVALID_HEADER         

# Phony targets
.PHONY: all bonus clean fclean re run valgrind norm
